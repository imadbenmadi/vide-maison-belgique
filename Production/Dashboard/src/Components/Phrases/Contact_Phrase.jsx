        ...
        const fetchData = async () => {
            try {
                const response = await axios.get(
                    "https://api.vide-maisonbelgique.org/Admin/Phrase_Contact",
                    {
        ...
        try {
            ...
            if (response.status === 200) {
                Swal.fire({
                    icon: "success",
                    title: "Success",
                    text: "Contact Phrase page mis à jour avec succès!",
                });
            }
        } catch (error) {
            console.error(error);
