        ...
        const FetchData = async () => {
            try {
                ...
                const demandsResponse = await axios.get(
                    `https://api.vide-maisonbelgique.org/Admin/Demands`,
                    {
    ...
    const handleAddType = async () => {
        ...
        try {
            const response = await axios.post(
                `https://api.vide-maisonbelgique.org/Admin/Demands/types`,
                { type: newType },
                {
                    withCredentials: true,
                    validateStatus: () => true,
    ...
    const handleDeleteType = async (id) => {
        try {
            const response = await axios.delete(
                `https://api.vide-maisonbelgique.org/Admin/Demands/types/${id}`,
                {
                    withCredentials: true,
                    validateStatus: () => true,
                }
